# ngx-extended-pdf-viewer meets JHipster

This is a demo application showing how to add ngx-extended-pdf-viewer to a JHipster 6.6 application.

# default text

Everything below is the default README generated by JHipster.
...
To build the final jar and optimize the pdfhipster application for production, run:
